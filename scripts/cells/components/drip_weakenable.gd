...
#		move_resistance_component.set_moveable(true)
		...
		var weakened_transformation_cell = fire_component_event.call_func(ComponentEventDestination.FOREGROUND_MANAGER, "create_cellv", [weakened_transformation_cell_type])
